...
-(void) onEnter
{
    ...
    // user need to click button to start game //
    // add menus //
    ...
    CCMenuItemLabel *item1 = [CCMenuItemLabel itemWithLabel:start target:self selector:@selector(makeTransition:)];
